...
turtles-own[
  satisfecho? ;;saber si esta satisfecho el agente
...
to setup
  ...
  ask patches[ ;lugares donde estaran los agentes
    set pcolor white
    if random 100 < densidad-poblacional [
...
to go
  ...
  mover-tortuga-insatisfechas ;;mocerlas a eapacio vacio si no estan satisfechas
  actualizar-tortugas
  actualizar-variables
  tick
end
...
to buscar-nuevo-lugar ;caminata aleatoria buscando nuevo lugar
  rt random-float 360
  fd random-float 10
